...
const stats = [
  ...
  { label: 'Average number of children per class', value: '30+' },
...
export const Stats = () => {
  return (
    <section
      className={clsx(
        'relative w-full bg-blue-600 px-4 py-16 sm:px-6 sm:py-24 lg:px-8',
        gochiHand.variable,
      )}
    >
      {/* Container */}
      <div className="mx-auto max-w-screen-xl">
        ...
        <div>
          <h2 className="h2 mx-auto max-w-4xl text-center text-white">
            Giving your student the best possible start to their education
          </h2>
        ...
        <div className="mt-12 gap-y-16 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:gap-y-12 md:gap-x-8 lg:gap-x-12">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="mt-0.5 text-lg font-medium text-white sm:mt-1.5 lg:text-xl">
                {stat.label}
              </p>
            </div>
          ))}
