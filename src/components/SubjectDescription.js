...
import dotsPurpleMess from '/public/images/illustrations/dots-blue-mess.svg'

export const SubjectDescription = ({ data }) => {
  return (
    <section className="relative overflow-hidden">
      {/* Purple background to fill in right gap */}
      <div className="absolute inset-y-0 left-0 ml-auto w-full max-w-screen-xl rounded-r-5xl bg-blue-300" />
      {/* Background dots decorations */}
      <Image
        src={dotsChaos}
        className="absolute bottom-0 left-0 z-10 hidden h-auto w-80 transform 2xl:block"
        alt=""
      />
      <Image
        src={dotsStrip}
        className="absolute left-20 top-1 z-10 hidden h-auto w-36 transform 2xl:block"
        alt=""
      />
      {/* Main Section */}
      <div className="relative w-full bg-blue-300 px-4 py-16 sm:px-6 sm:py-24 lg:py-0 lg:pr-0 2xl:mx-auto 2xl:max-w-screen-xl 2xl:rounded-r-5xl">
        <div className='mx-auto max-w-xl lg:max-w-screen-xl'>
        <div className="relative grid gap-12 lg:grid-cols-2 lg:pr-10 2xl:gap-4 2xl:pr-0">
          <div className="relative order-2 mx-auto grid w-full max-w-2xl grid-cols-2 gap-3 sm:gap-6 lg:max-w-none lg:py-32 container">
            <Image
              src={dotsPurpleMess}
              className="absolute -left-16 top-12 hidden transform lg:block 2xl:left-0 "
              alt=""
            />
          ...
          <div className="order-1 flex flex-col justify-center lg:py-36">
            <div
