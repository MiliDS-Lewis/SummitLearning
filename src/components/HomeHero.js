...
export const HomeHero = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-blue-50 to-blue-100 px-4 pt-16 sm:px-6 lg:px-8">
      {/* Hero container */}
      <div
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center lg:col-span-6 lg:items-start">
          ...
          <div className="mt-8 flex flex-col items-center overflow-hidden sm:flex-row">
            <Button href="#0" className="text-white">
              Book a call
              <Icon
                icon="phone"
          ...
          {/* Social proof */}
          <p className="mt-14 hidden text-sm font-medium uppercase tracking-wider text-blue-900 sm:block lg:hidden xl:block">
            Rated 5 stars by over{' '}
            <span className="font-semibold text-blue-600">100 parents</span>
          </p>
          <div className="mt-8 hidden flex-col divide-y divide-blue-400/20 overflow-hidden sm:mt-5 sm:flex sm:flex-row sm:divide-x sm:divide-y-0 lg:hidden xl:flex">
            {ratings.map((rating, index) => (
              ...
              >
                ...
                <p className="mt-2.5 text-xs font-bold uppercase tracking-wide text-blue-700">
                  {rating.label}
                </p>
              </div>
            ))}
      ...
      <div className="mt-20 flex flex-col items-center sm:hidden lg:mt-24 lg:flex xl:hidden">
        ...
        <div className="mt-8 flex flex-col divide-y divide-blue-400/20 overflow-hidden sm:flex-row sm:divide-x sm:divide-y-0">
          {ratings.map((rating, index) => (
            <div
            ...
            >
              <div className="flex w-full justify-center space-x-1">
                {[...Array(rating.stars)].map((e, i) => (
                  <Icon
                    icon="starFilled"
                    className="h-4.5 w-4.5 text-white lg:h-5 lg:w-5"
