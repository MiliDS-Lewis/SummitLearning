      ...
      <div className="block lg:hidden">
        <Popover>
          ...
          >
            <Popover.Panel
              as="div"
              className="absolute inset-x-0 top-0 z-40 w-screen overflow-y-scroll bg-gradient-to-tr from-blue-600 to-blue-600 px-4 py-16 sm:px-8"
            >
              <div className="flex h-full w-full flex-col items-center justify-center">
                ...
                <hr className="my-8 w-full border-blue-200 border-opacity-30 sm:my-10" />

                <div className="mx-auto w-full max-w-md">
                  <p className="text-center text-lg font-semibold uppercase tracking-wider text-blue-200 sm:text-left">
                    Programs
                  </p>
              ...
              <hr className="my-1 border-blue-200/30 sm:my-2" />
                  ...
                  <Link href={link.href}>
                    <div className="group relative p-0.5">
                      ...
                      <span
                        className={clsx(
                          'absolute -left-1 -right-1 bottom-0 h-0.5 origin-bottom scale-x-0 transform rounded-lg bg-blue-400',
                          pathname == link.href
                            ? 'scale-x-100'
