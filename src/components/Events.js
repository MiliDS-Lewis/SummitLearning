...
const eventColors = ['bg-yellow-200', 'bg-blue-50', 'bg-rose-50', 'bg-teal-50']
  ...
  return (
    <section className="relative w-full px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl lg:max-w-screen-xl">
        ...
        <div>
          <h2 className="h2 text-blue-900 lg:text-center">Upcoming events</h2>
          <p className="mx-auto mt-3 max-w-2xl text-xl leading-relaxed text-blue-800 lg:mt-4 lg:text-center">
        ...
        <div className="mt-12 sm:mt-16 lg:grid lg:grid-cols-2 lg:gap-6 xl:gap-8">
          {events.map((event, index) => (
            ...
            >
              ...
              >
                <div>
                  <div className="inline-flex -rotate-1 items-center justify-center rounded-xl bg-blue-200 px-3.5 py-0.5 align-top text-sm font-medium leading-6 text-blue-700">
                    {event.data.dates}
                  </div>
                </div>
                <h4 className="mt-4 text-2xl font-bold text-blue-900 sm:text-3xl lg:text-2xl lg:leading-tight xl:text-3xl xl:leading-tight">
                  {event.data.name}
                </h4>
                <p className="mt-1 text-blue-800 lg:mt-2">
