...
export const ProgramDescription = ({ data }) => {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 ml-auto w-full max-w-screen-xl rounded-l-5xl bg-blue-600" />
      ...
      />
      {/* Main Section */}
      <div className="relative w-full bg-blue-600 px-4 py-16 sm:px-6 sm:py-24 lg:py-0 lg:pr-0 2xl:mx-auto 2xl:max-w-screen-xl 2xl:rounded-l-5xl">
